...
var QuarterPageRoutingModule = /** @class */ (function () {
    function QuarterPageRoutingModule() {
    }
    ...
    return QuarterPageRoutingModule;
}());
...
var QuarterPageModule = /** @class */ (function () {
    function QuarterPageModule() {
    }
...
var QuarterPage = /** @class */ (function () {
    function QuarterPage(router, syncService, loadingCtrl, datePipe, plt, socialSharing, file, fileOpener, storage) {
        var _this = this;
        this.router = router;
    ...
    QuarterPage.prototype.ngOnInit = function () {
    };
    QuarterPage.prototype.share = function () {
        // this.getData();
        this.createPdf();
    };
    QuarterPage.prototype.back = function () {
        this.router.navigate(['/menu/reports']);
    };
    QuarterPage.prototype.onActivate = function (event) {
        if (event.type === 'click') {
            console.log(event.row);
        }
    };
    QuarterPage.prototype.getData = function () {
    ...
    QuarterPage.prototype.changeDate = function () {
        this.i = this.i + 1;
    ...
    QuarterPage.prototype.getQ1 = function () {
        var _this = this;
        ...
        this.syncService.getsales(first1, last1, this.currency).then(function (data) {
            _this.total = data;
            var data1 = {
                month: 'Q1',
    ...
    QuarterPage.prototype.getQ2 = function () {
        var _this = this;
    ...
    QuarterPage.prototype.getQ3 = function () {
        var _this = this;
    ...
    QuarterPage.prototype.getQ4 = function () {
        var _this = this;
    ...
    QuarterPage.prototype.createPdf = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    QuarterPage.prototype.downloadPdf = function (loading) {
        var _this = this;
        debugger;
    ...
    QuarterPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-reports-quarter-quarter-module-es5.js.map