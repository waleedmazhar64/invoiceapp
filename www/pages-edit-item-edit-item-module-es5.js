...
var EditItemPage = /** @class */ (function () {
    ...
    EditItemPage.prototype.back = function () {
        debugger;
        var navigationExtras = {
            state: {
                edititem: this.item,
    ...
    EditItemPage.prototype.rateClicked = function (position) {
    ...
    EditItemPage.prototype.qtyClicked = function (position) {
    ...
    EditItemPage.prototype.tax = function (value, position) {
        console.log(value.detail.checked, position);
        this.selectdItems[position].tax = value.detail.checked;
    };
    EditItemPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-edit-item-edit-item-module-es5.js.map