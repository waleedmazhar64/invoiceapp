...
var LedgersVendorsPageRoutingModule = /** @class */ (function () {
    function LedgersVendorsPageRoutingModule() {
    }
    ...
    return LedgersVendorsPageRoutingModule;
}());
...
var LedgersVendorsPageModule = /** @class */ (function () {
    function LedgersVendorsPageModule() {
    }
    ...
    return LedgersVendorsPageModule;
}());
...
var LedgersVendorsPage = /** @class */ (function () {
    function LedgersVendorsPage(router, syncService, databaseService, loadingCtrl, callnumber, datePipe, socialSharing, file, fileOpener, storage, plt, events) {
        var _this = this;
        this.router = router;
        ...
        this.currency = '';
        this.pdfObj = null;
        events.subscribe('refreshClientLedger', function (user, time) {
            alert('yes');
            _this.getLedger();
        });
        ...
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationStart"]; })).subscribe(function (route) {
            ...
            var a = _this.databaseService.getupdatevendorLedger();
            debugger;
    ...
    LedgersVendorsPage.prototype.ngOnInit = function () {
    };
    LedgersVendorsPage.prototype.back = function () {
        this.databaseService.setupdatevendors(1);
        this.router.navigate(['/menu/vendors']);
    };
    LedgersVendorsPage.prototype.addPayment = function () {
        debugger;
    ...
    LedgersVendorsPage.prototype.editVendor = function () {
        debugger;
        this.syncService.getVendor(this.client.ID);
    };
    LedgersVendorsPage.prototype.itemClick = function (item) {
    ...
    LedgersVendorsPage.prototype.call = function () {
        var number = this.client.Phone;
        this.callnumber.callNumber(number, true)
            .then(function (res) { return console.log('Launched dialer!', res); })
            .catch(function (err) { return console.log('Error launching dialer', err); });
    };
    LedgersVendorsPage.prototype.getLedger = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.totalDebit = 0;
                        this.totalCredit = 0;
                        this.syncService.getVendorLedger(this.client.ID).then(function (data) {
                            debugger;
                            _this.ledger = data;
                            for (var i = 0; i < _this.ledger.length; i++) {
                                ...
                                _this.ledger[i].Date = _this.datePipe.transform(_this.ledger[i].Date, 'dd MMM yyyy');
                            }
    ...
    LedgersVendorsPage.prototype.addPO = function () {
        this.router.navigate(['addpurchasedorder']);
    };
    LedgersVendorsPage.prototype.share = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    LedgersVendorsPage.prototype.Sms = function () {
        var number = this.client.Phone;
        this.socialSharing.shareViaSMS('', number).then(function () {
        }).catch(function () {
        });
    };
    LedgersVendorsPage.prototype.createPdf = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    LedgersVendorsPage.prototype.downloadPdf = function (loading) {
        var _this = this;
    ...
    LedgersVendorsPage.prototype.editPayment = function (item) {
        var navigationExtras = {
            state: {
                ID: item.ID,
                Amount: item.Amount,
    ...
    LedgersVendorsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-ledgers-vendors-ledgers-vendors-module-es5.js.map