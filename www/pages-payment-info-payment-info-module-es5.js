...
var PaymentInfoPage = /** @class */ (function () {
    function PaymentInfoPage(router, datePipe, datePicker, syncService, databaseservice, network, nativeHttp, storage, events) {
        var _this = this;
        this.router = router;
    ...
    PaymentInfoPage.prototype.back = function () {
        debugger;
    ...
    PaymentInfoPage.prototype.onActivate = function (event) {
        if (event.type === 'click') {
            console.log(event.row);
        }
    };
    PaymentInfoPage.prototype.selectDate = function () {
        var _this = this;
        var options = {
            date: new Date(),
            mode: 'date',
    ...
    PaymentInfoPage.prototype.AddLog = function () {
        var _this = this;
        if (this.edit === 0) {
            if (this.usdId === 1) {
    ...
    PaymentInfoPage.prototype.addpayment = function () {
        var _this = this;
        if (this.edit === 0) {
            ...
            if (parseInt(this.Amount) > 0) {
                ...
                debugger;
                this.syncService.addPayment(this.Cid, this.clientSync, a, parseInt(this.Amount), this.Remarks).then(function (data) {
                    data;
                    _this.events.publish('refreshLedger', 'saad2', '');
                    _this.databaseservice.setupdateclients(1);
                    _this.databaseservice.setupdateclientLeger(1);
                    if (_this.url === '/ledger') {
                        debugger;
        ...
        if (this.edit === 1) {
            ...
            if (parseInt(this.Amount) > 0) {
                ...
                this.syncService.editPayment(this.Cid, this.clientSync, this.date, parseInt(this.Amount), this.Remarks, this.paymentID, this.tempAmount, this.ledgerSync).then(function (data) {
                    data;
                    _this.databaseservice.setupdateclients(1);
                    _this.databaseservice.setupdateclientLeger(1);
                    if (_this.url === '/ledger') {
    ...
    PaymentInfoPage.prototype.syncAddedPayment = function () {
        var _this = this;
    ...
    PaymentInfoPage.prototype.syncUpdatedPayment = function () {
        var _this = this;
        this.syncService.syncUpdatedLedger().then(function (data) {
            if (data.length > 0) {
                var IDs_3 = [];
                for (var i = 0; i < data.length; i++) {
                    IDs_3[i] = data[i].ID;
    ...
    PaymentInfoPage.prototype.open = function (row, value) {
        debugger;
    ...
    PaymentInfoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-payment-info-payment-info-module-es5.js.map