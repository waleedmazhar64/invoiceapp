...
var InvoiceInfoPageModule = /** @class */ (function () {
    function InvoiceInfoPageModule() {
    }
...
var InvoiceInfoPage = /** @class */ (function () {
    function InvoiceInfoPage(storage, router, datePipe, datePicker, alertCtrl) {
    ...
    InvoiceInfoPage.prototype.ngOnInit = function () {
    ...
    //    localStorage.setItem('DUE',this.due);  
    //  }
    InvoiceInfoPage.prototype.back = function () {
    ...
    InvoiceInfoPage.prototype.selectDate = function () {
        var _this = this;
        var options = {
            date: new Date(),
            mode: 'date',
        ...
        this.datePicker.show(options).then(function (date) {
            _this.invoice.created = _this.datePipe.transform(date, 'dd-MM-yyyy');
            // console.log('selected:',this.myDate);
        });
    };
    InvoiceInfoPage.prototype.selectDueDate = function () {
        var _this = this;
        var options = {
            date: new Date(),
            mode: 'date',
        ...
        this.datePicker.show(options).then(function (date) {
            _this.invoice.duedate = _this.datePipe.transform(date, 'dd-MM-yyyy');
            // console.log('selected:',this.myDate);
        });
    };
    InvoiceInfoPage.prototype.openAlert = function () {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function (data) {
                        ...
                        _this.invoice.terms = data;
                    }
                }
            ]
        }).then(function (alert) { return alert.present(); });
    };
    InvoiceInfoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-invoice-info-invoice-info-module-es5.js.map