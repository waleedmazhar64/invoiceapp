...
var PurchasedOrdersPageModule = /** @class */ (function () {
...
var PurchasedOrdersPage = /** @class */ (function () {
    function PurchasedOrdersPage(router, http, nativeHttp, plt, loadingCtrl, databaseprovider, callnumber, syncService, network, storage, datePipe, alertCtrl, socialSharing, file, fileOpener, events, location) {
        var _this = this;
        this.router = router;
        this.http = http;
        ...
        this.storage.get('app').then(function (val1) {
            if (val1 === 'invoice') {
                _this.storage.get('ID').then(function (val) {
                    _this.syncService.getbValue(val, 'PO Add').then(function (data) {
                        _this.showAdd = data[0].bValue;
                    });
                    _this.syncService.getbValue(val, 'PO Details').then(function (data) {
        ...
        events.subscribe('refreshPOS', function (user, time) {
    ...
    PurchasedOrdersPage.prototype.ionViewDidEnter = function () {
        // this.getAllPosLocaldb();
        var _this = this;
    ...
    PurchasedOrdersPage.prototype.ionViewWillLeave = function () {
        this.subscription.unsubscribe();
    };
    PurchasedOrdersPage.prototype.geItems = function (searchbar) {
        this.initializePOs();
    ...
    PurchasedOrdersPage.prototype.ngOnInit = function () {
    };
    PurchasedOrdersPage.prototype.addIcon = function () {
        this.router.navigate(['addpurchasedorder']);
    };
    PurchasedOrdersPage.prototype.edittxt = function () {
        alert('edit');
    };
    PurchasedOrdersPage.prototype.doRefresh = function (refresher) {
        this.getAllPosLocaldb();
    ...
    PurchasedOrdersPage.prototype.itemClicked = function (item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading_1, items_1;
            var _this = this;
    ...
    PurchasedOrdersPage.prototype.edit = function (item) {
        alert('edit:' + item.total);
    };
    PurchasedOrdersPage.prototype.del = function (item) {
        this.shareALert("Warning", '', 'Are you sure you want to delete this Purchased Order?', item);
    };
    PurchasedOrdersPage.prototype.shareALert = function (head, sub, msg, item) {
        var _this = this;
    ...
    PurchasedOrdersPage.prototype.delete = function (item) {
        var _this = this;
        debugger;
        ...
        this.syncService.getVendorSync(item.VendorID).then(function (data) {
            ...
            debugger;
            _this.syncService.deletePO(item.ID, item.Total, item.VendorID, vendorSync).then(function () {
                _this.databaseprovider.setupdatevendors(1);
                _this.databaseprovider.setupdatevendorLeger(1);
                _this.databaseprovider.setupdateitems(1);
                _this.getAllPosLocaldb();
                _this.AddLog();
    ...
    // }
    PurchasedOrdersPage.prototype.syncDeletedPO = function () {
        var _this = this;
    ...
    PurchasedOrdersPage.prototype.update = function () {
        //debugger;
        this.selectedCount = this.POs.filter(function (x) { return x.selected === true; }).length;
    };
    PurchasedOrdersPage.prototype.paid = function () {
        this.paidcolor = 'success';
        this.unpaidcolor = 'primary';
    };
    PurchasedOrdersPage.prototype.unpaid = function () {
        this.unpaidcolor = 'success';
        this.paidcolor = 'primary';
    };
    PurchasedOrdersPage.prototype.back = function () {
        this.s = 0;
        this.paidcolor = 'primary';
        this.unpaidcolor = 'primary';
    };
    PurchasedOrdersPage.prototype.back1 = function () {
        this.router.navigate(['/menu/dashboard']);
    };
    PurchasedOrdersPage.prototype.getAllPOS = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    PurchasedOrdersPage.prototype.initializePOs = function () {
        this.tempPOS = this.POs;
    };
    PurchasedOrdersPage.prototype.editClick = function () {
        this.items;
        this.POitems;
        this.tempPOS;
    ...
    PurchasedOrdersPage.prototype.deleteSelected = function () {
        this.POs;
        debugger;
    };
    PurchasedOrdersPage.prototype.getAllPosLocaldb = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        //   debugger
                        // });
                        this.syncService.getActivePOSPagination(this.records).then(function (data) {
                            debugger;
                            _this.POs = data;
                            _this.databaseprovider.setupdatePOS(0);
                            _this.initializePOs();
    ...
    PurchasedOrdersPage.prototype.doInfinite = function (infiniteScroll) {
        var _this = this;
        ...
        if (this.totalRecords <= this.records) {
            ...
            this.page++;
            this.syncService.getActivePOSPagination(this.records).then(function (data) {
                _this.POs = _this.POs.concat(data);
                _this.initializePOs();
    ...
    PurchasedOrdersPage.prototype.AddLog = function () {
        var _this = this;
        if (this.usdId === 1) {
    ...
    PurchasedOrdersPage.prototype.share = function (item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    PurchasedOrdersPage.prototype.createPdf = function (item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var items, loading;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    PurchasedOrdersPage.prototype.downloadPdf = function (loading) {
        var _this = this;
    ...
    PurchasedOrdersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=purchased-orders-purchased-orders-module-es5.js.map