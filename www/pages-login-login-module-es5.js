...
var LoginPage = /** @class */ (function () {
    function LoginPage(platform, router, googlePlus, databaseprovider, storage, alrtCtrl, network, loadingController, statusbar, toastController, syncService, datePipe, nav, events) {
        var _this = this;
        ...
        storage.get('first_time').then(function (val) {
            if (val !== null) {
                ...
                _this.storage.set('COM', 'M.A. Traders Alipur Chatha');
                // this.storage.set('COM', 'invoice.pk');
                // this.storage.set('COM', 'Tiny Invoice');
                _this.storage.set('Sync', '');
            }
        });
        ...
        storage.get('imgUrl').then(function (val) {
            _this.imageUrl = val;
        });
        //this.getAll();
    }
                        ...
                        if (this.network.type === 'none') {
                            ...
                            this.googlePlus.login({})
                                ...
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    ...
                                    this.syncService.checKEmail(this.email).then(function (data) {
                                        if (data[0].success === 1) {
                                            console.log('matched');
                                            _this.storage.set("UserName", res.displayName);
                                            _this.storage.set('loginStatus', 'true');
                                            _this.storage.set('loginEmail', res.email);
                                            _this.storage.set('ID', data[0].ID);
                                            _this.events.publish('refreshShowPages', 'saad', '');
                                            _this.addAccount(res.email, res.userId);
                                            loading.dismiss();
                                        }
                                        if (data[0].success === 0) {
                                            _this.logout();
    ...
    LoginPage.prototype.onButtonClick = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    LoginPage.prototype.addAccount = function (email, userId) {
        var _this = this;
        // alert('addaccount');
        this.databaseprovider.addaccount(email, userId)
            ...
            _this.AddLog();
            _this.nav.navigateRoot('/menu/clients');
            // this.router.navigate(['/menu/dashboard']);
        });
    ...
    LoginPage.prototype.account = function () {
        var _this = this;
        this.databaseprovider.getAccount(this.userId).then(function (data) {
            _this.accounts = data;
            _this.confirm = _this.accounts.passcode;
            ;
            console.log(_this.accounts.passcode);
        });
    };
    LoginPage.prototype.getStatus = function () {
        var _this = this;
        this.databaseprovider.getLogUpdate(this.userId, this.isLoggedIn).then(function (data) {
            _this.loadInfo();
            _this.accounts = data;
        });
    };
    LoginPage.prototype.loadInfo = function () {
        var _this = this;
        this.databaseprovider.getAllAccount().then(function (data) {
            _this.accounts = data;
        });
    };
    LoginPage.prototype.showALert = function (head, sub, msg) {
        var _this = this;
    ...
    LoginPage.prototype.AddLog = function () {
        var _this = this;
        // this.userName = name;
        if (this.executed === 0) {
            if (this.usdId === 1) {
    ...
    LoginPage.prototype.storeUsers = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
