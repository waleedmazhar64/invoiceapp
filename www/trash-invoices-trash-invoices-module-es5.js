...
var TrashInvoicesPageRoutingModule = /** @class */ (function () {
    function TrashInvoicesPageRoutingModule() {
    }
    ...
    return TrashInvoicesPageRoutingModule;
}());
...
var TrashInvoicesPageModule = /** @class */ (function () {
    function TrashInvoicesPageModule() {
    }
    ...
    return TrashInvoicesPageModule;
}());
...
var TrashInvoicesPage = /** @class */ (function () {
    function TrashInvoicesPage(actionSheetController, router, databaseprovider, loadingCtrl, nativeHttp, syncService, datePipe, network, storage, socialSharing, alertCtrl, navCtrl, plt, file, fileOpener) {
        var _this = this;
        ...
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__["NavigationStart"]; })).subscribe(function (route) {
            console.log('Route: ' + route.url);
            var a = _this.databaseprovider.getupdateinvoice();
            debugger;
    ...
    TrashInvoicesPage.prototype.ngOnInit = function () {
        this.getStartDate();
        localStorage.setItem('DATE', this.ldates);
        localStorage.setItem('TERM', '30');
        localStorage.setItem('INV', '300');
    };
    TrashInvoicesPage.prototype.initializeactiveItems = function () {
        this.tempItems = this.items;
    };
    TrashInvoicesPage.prototype.presentActionSheet = function () {
    ...
    TrashInvoicesPage.prototype.getformattedDate = function () {
    ...
    TrashInvoicesPage.prototype.getStartDate = function () {
    ...
    TrashInvoicesPage.prototype.Invoice = function () {
        this.up = localStorage.getItem("INV");
        this.up++;
        localStorage.setItem("INV", this.up);
    };
    TrashInvoicesPage.prototype.edittxt = function () {
        alert('edit');
    };
    TrashInvoicesPage.prototype.doRefresh = function (refresher) {
        this.getAllInvoicesLocaldb();
    ...
    TrashInvoicesPage.prototype.itemClicked = function (item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading, items;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    TrashInvoicesPage.prototype.edit = function (item) {
        alert('edit:' + item.total);
    };
    TrashInvoicesPage.prototype.restore = function (item) {
        var _this = this;
        debugger;
        this.tblId = item.Iid;
        this.syncService.getCustomerSync(item.Cid).then(function (data) {
            ...
            debugger;
            _this.syncService.restoreInvoice(item.Iid, item.Total, item.Cid, customerSync).then(function () {
                _this.getAllInvoicesLocaldb();
                _this.AddLog();
                if (_this.network.type === 'none') {
                    ...
                    debugger;
                    _this.syncRestoredInvoices();
                }
            });
        });
        // alert('del:' + item.total);
    };
    TrashInvoicesPage.prototype.syncRestoredInvoices = function () {
        var _this = this;
        debugger;
    ...
    TrashInvoicesPage.prototype.update = function () {
        //debugger;
        this.selectedCount = this.invoices.filter(function (x) { return x.selected === true; }).length;
    };
    TrashInvoicesPage.prototype.addIcon = function () {
        this.router.navigate(['addinvoice']);
    };
    TrashInvoicesPage.prototype.paid = function () {
        this.paidcolor = 'success';
        this.unpaidcolor = 'primary';
    };
    TrashInvoicesPage.prototype.unpaid = function () {
        this.unpaidcolor = 'success';
        this.paidcolor = 'primary';
    };
    TrashInvoicesPage.prototype.back = function () {
        debugger;
        this.s = 0;
        this.paidcolor = 'primary';
        this.unpaidcolor = 'primary';
    };
    TrashInvoicesPage.prototype.geItems = function (searchbar) {
    ...
    TrashInvoicesPage.prototype.getDataNativeHttp = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    TrashInvoicesPage.prototype.initializeInvoices = function () {
        debugger;
        this.tempInvoices = this.invoices;
    };
    TrashInvoicesPage.prototype.editClick = function () {
    ...
    TrashInvoicesPage.prototype.getAllInvoicesLocaldb = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        this.syncService.getAllInvoices3().then(function (data) {
                            debugger;
                            _this.invoices = data;
    ...
    TrashInvoicesPage.prototype.AddLog = function () {
        var _this = this;
        if (this.usdId === 1) {
    ...
    TrashInvoicesPage.prototype.createPdf = function (item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    TrashInvoicesPage.prototype.downloadPdf = function (loading) {
        var _this = this;
        debugger;
    ...
    TrashInvoicesPage.ctorParameters = function () { return [
...
//# sourceMappingURL=trash-invoices-trash-invoices-module-es5.js.map