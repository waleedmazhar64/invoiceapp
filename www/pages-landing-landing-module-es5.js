...
var LandingPage = /** @class */ (function () {
    function LandingPage(plt, nav, googleplus, databaseprovider, platform, router, storage) {
        ...
        this.storage.get('ID').then(function (val) {
            if (val !== null) {
                ...
                setTimeout(function () {
                    // this.router.navigateByUrl('/menu/dashboard');
                    _this.nav.navigateRoot('/menu/dashboard');
                }, 3000);
                debugger;
        ...
        storage.get('first_time').then(function (val) {
            if (val !== null) {
                ...
                // this.storage.set('COM', 'Tiny Invoice');
                _this.storage.set('COM', 'invoice.pk');
    ...
    LandingPage.prototype.checkLogin = function () {
    ...
    LandingPage.prototype.account = function () {
        var _this = this;
        this.databaseprovider.getLogAccount(this.status).then(function (data) {
            _this.loadInfo();
            _this.accounts = data;
            _this.confirm = _this.accounts.logup;
            console.log(_this.accounts.logup);
        });
    };
    LandingPage.prototype.loadInfo = function () {
        var _this = this;
        this.databaseprovider.getAllAccount().then(function (res) {
            _this.acc = res;
        });
    };
    LandingPage.prototype.navigationMode = function () {
        var _this = this;
        //localStorage.getItem('file');
        //console.log(localStorage.getItem('file'));
    ...
    LandingPage.prototype.addIt = function () {
        var _this = this;
    ...
    LandingPage.prototype.getAll = function () {
        var _this = this;
        this.databaseprovider.getAllAccountData().then(function (data) {
            _this.accounts = data;
