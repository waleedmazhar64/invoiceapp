...
var CustomerstatementPageRoutingModule = /** @class */ (function () {
    function CustomerstatementPageRoutingModule() {
    }
    ...
    return CustomerstatementPageRoutingModule;
}());
...
var CustomerstatementPageModule = /** @class */ (function () {
    function CustomerstatementPageModule() {
    }
    ...
    return CustomerstatementPageModule;
}());
...
var CustomerstatementPage = /** @class */ (function () {
    function CustomerstatementPage(router, syncService, loadingCtrl, datePipe, datepicker, plt, socialSharing, file, fileOpener, storage) {
        var _this = this;
        this.router = router;
    ...
    CustomerstatementPage.prototype.ngOnInit = function () {
    };
    CustomerstatementPage.prototype.share = function () {
        // this.getData();
    };
    CustomerstatementPage.prototype.back = function () {
        this.router.navigate(['/menu/reports']);
    };
    CustomerstatementPage.prototype.getAllData = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        this.syncService.getSalesByCustomerStatement().then(function (data) {
                            _this.total = data;
    ...
    CustomerstatementPage.prototype.itemClicked = function (customer, pos) {
        ...
        this.total = this.total.slice();
    };
    CustomerstatementPage.prototype.selectStartDate = function () {
        var _this = this;
        var options = {
            date: new Date(),
            mode: 'date',
    ...
    CustomerstatementPage.prototype.selectEndDate = function () {
        var _this = this;
        var options = {
            date: new Date(),
            mode: 'date',
    ...
    CustomerstatementPage.prototype.all = function () {
        this.allcolor = 'primary';
        this.thismonthcolor = 'dark';
        this.lastmonthcolor = 'dark';
        this.selected = 3;
    };
    CustomerstatementPage.prototype.thisMonth = function () {
    ...
    CustomerstatementPage.prototype.lastMonth = function () {
    ...
    CustomerstatementPage.prototype.createStatement = function (customer) {
        var _this = this;
        // alert('s ' + customer.Cid);
        if (this.selected === 3) {
            this.syncService.getSalesByCustomerId(customer.Cid).then(function (data) {
                _this.customerinvoices = data;
                // alert('y' + this.customerinvoices.length);
                _this.createPdf(customer);
            });
        }
        else {
            // alert('s ' + this.startdate + 'end ' + this.enddate);
            this.syncService.getSalesByCustomerIdTime(customer.Cid, this.startdate, this.enddate, this.currency).then(function (data) {
                _this.customerinvoices = data;
                // alert('y' + this.customerinvoices.length);
                _this.syncService.getSalesAndPaidByCustomertime(customer.Cid, _this.startdate, _this.enddate).then(function (data1) {
                    _this.customersales = data1;
    ...
    CustomerstatementPage.prototype.createPdf = function (customer) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        itemss = [];
                        for (i = 0; i < this.customerinvoices.length; i++) {
                            itemss.push([
    ...
    CustomerstatementPage.prototype.downloadPdf = function (loading) {
        var _this = this;
        debugger;
        if (this.plt.is('cordova')) {
            this.pdfObj.getBuffer(function (buffer) {
                ...
                _this.file.writeFile(_this.file.dataDirectory, a + '.pdf', blob).then(function (fileEntry) {
                    _this.fileOpener.open(_this.file.dataDirectory + a + '.pdf', 'application/pdf');
                    loading.dismiss();
                });
    ...
    CustomerstatementPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-reports-customerstatement-customerstatement-module-es5.js.map