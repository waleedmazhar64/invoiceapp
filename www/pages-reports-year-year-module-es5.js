...
var YearPageRoutingModule = /** @class */ (function () {
    function YearPageRoutingModule() {
    }
...
var YearPageModule = /** @class */ (function () {
    function YearPageModule() {
    }
...
var YearPage = /** @class */ (function () {
    function YearPage(router, syncService, loadingCtrl, datePipe, storage, plt, socialSharing, file, fileOpener) {
        var _this = this;
        this.router = router;
        ...
        var lastdateofyear = this.datePipe.transform(last, 'dd MMM yyyy');
    ...
    YearPage.prototype.ngOnInit = function () {
    };
    YearPage.prototype.share = function () {
        // this.getData();
        this.createPdf();
    };
    YearPage.prototype.back = function () {
        this.router.navigate(['/menu/reports']);
    };
    YearPage.prototype.onActivate = function (event) {
        if (event.type === 'click') {
            console.log(event.row);
        }
    };
    YearPage.prototype.getData = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        this.syncService.getSalesByYear('2020').then(function (data) {
                            _this.total = data;
                            // alert(this.total[0].Total);
                            for (var i = 0; i < _this.total.length; i++) {
                                var data1 = {
                                    year: _this.total[i].Year,
                                    sales: _this.currency + _this.total[i].Total,
                                    paid: _this.currency + _this.total[i].Paid,
                                };
    ...
    YearPage.prototype.createPdf = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    YearPage.prototype.downloadPdf = function (loading) {
        var _this = this;
        debugger;
    ...
    YearPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-reports-year-year-module-es5.js.map