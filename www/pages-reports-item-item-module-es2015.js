...
let ItemPage = class ItemPage {
    ...
    getDataTime() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.syncService.getSalesByItemTime(this.startdate, this.enddate, this.currency).then((data) => {
                this.total = data;
                for (let i = 0; i < this.total.length; i++) {
                    const data1 = {
                        item: this.total[i].Description,
                        sales: this.total[i].CostPrice,
                        qty: this.total[i].Qty,
                    };
    ...
    getAllData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let loading = yield this.loadingCtrl.create();
            yield loading.present();
            this.syncService.getSalesByItem(this.currency).then((data) => {
                this.total = data;
                for (let i = 0; i < this.total.length; i++) {
                    const data1 = {
                        item: this.total[i].Description,
    ...
    selectStartDate() {
        ...
        this.datepicker.show(options).then((date) => {
            ...
            this.displaystartdate = this.datePipe.transform(date, 'dd MMM yyyy');
            this.data = [];
            this.getDataTime();
            this.thismonthcolor = 'dark';
            this.lastmonthcolor = 'dark';
    ...
    selectEndDate() {
        ...
        this.datepicker.show(options).then((date) => {
            ...
            this.displayenddate = this.datePipe.transform(date, 'dd MMM yyyy');
            this.thismonthcolor = 'dark';
            this.lastmonthcolor = 'dark';
            this.thisquartercolor = 'dark';
            this.allcolor = 'dark';
...
//# sourceMappingURL=pages-reports-item-item-module-es2015.js.map