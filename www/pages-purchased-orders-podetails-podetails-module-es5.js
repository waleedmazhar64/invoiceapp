...
var PodetailsPage = /** @class */ (function () {
    function PodetailsPage(location, alrtCtrl, router, toastController, storage, loadingController, ref, filePath, datePipe, events, file, webview, actionSheetController, camera, plt, http, databaseprovider, nativeHttp, alertCtrl, syncService, network, callnumber, sms, socialSharing, nav) {
        var _this = this;
    ...
    PodetailsPage.prototype.back = function () {
    ...
    PodetailsPage.prototype.showALert = function (head, sub, msg) {
        var _this = this;
    ...
    PodetailsPage.prototype.share = function () {
    ...
    PodetailsPage.prototype.shareALert = function (head, sub, msg) {
        var _this = this;
        this.alrtCtrl.create({
            header: head,
            subHeader: sub,
    ...
    PodetailsPage.prototype.addClient = function () {
    ...
    PodetailsPage.prototype.addItem = function () {
        var navigationExtras = {
            state: {
                url: this.url
            }
    ...
    PodetailsPage.prototype.comment = function () {
        var navigationExtras = {
            state: {
                user: this.message,
                url: this.url
    ...
    // }
    PodetailsPage.prototype.editItem = function (item, pos) {
        console.log(pos);
    ...
    PodetailsPage.prototype.clearAll = function () {
        this.discount = 0.00;
        this.subtotal = 0.00;
        this.total = 0.00;
    ...
    //   debugger
    // }
    PodetailsPage.prototype.openAlert = function () {
        var _this = this;
        this.alrtCtrl.create({
            header: 'Vendors',
            inputs: this.raio,
    ...
    PodetailsPage.prototype.getAllClients = function () {
    ...
    PodetailsPage.prototype.sortClients = function () {
        debugger;
    ...
    PodetailsPage.prototype.initializeactiveVendors = function () {
        this.tempActiveVendors = this.activeVendors;
    };
    PodetailsPage.prototype.getAllItems = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading, url, nativeCall;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    PodetailsPage.prototype.sortItems = function () {
        debugger;
    ...
    PodetailsPage.prototype.initializeActiveItems = function () {
        this.tempActiveItems = this.activeItems;
        debugger;
    };
    PodetailsPage.prototype.quantityIncrement = function (item) {
        item.Qty = item.Qty + 1;
        this.subtotal = this.subtotal + (1 * item.CostPrice);
        this.total = this.subtotal - this.discount;
        debugger;
    };
    PodetailsPage.prototype.quantityDecrement = function (item) {
        if (item.Qty > 0) {
            this.subtotal = this.subtotal - (1 * item.CostPrice);
            this.total = this.subtotal - this.discount;
            item.Qty = item.Qty - 1;
    ...
    PodetailsPage.prototype.change = function () {
    };
    PodetailsPage.prototype.presentPrompt = function () {
    ...
    PodetailsPage.prototype.savePO = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading, i, itemsArray, i, a, url, nativeCall;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.loadingController.create()];
                    ...
                    case 2:
                        ...
                        url = this.databaseprovider.getURL();
                        this.nativeHttp.setDataSerializer("json");
                        nativeCall = this.nativeHttp.post(url + '/updatePO.php', {
                            "PoId": this.PO.ID,
    ...
    PodetailsPage.prototype.updatePO = function () {
        var _this = this;
        for (var i = 0; i < this.items.length; i++) {
        ...
        debugger;
        var VendorBalance = this.total - this.tempTotal;
        debugger;
    ...
    PodetailsPage.prototype.discountPrompt = function () {
        var _this = this;
        if (this.total > 0) {
            this.alertCtrl.create({
                header: 'Discount',
    ...
    PodetailsPage.prototype.updateTotal = function (searchbar, item) {
    ...
    //   this.total = this.subtotal - this.discount;
    // }
    PodetailsPage.prototype.getAllVendors = function () {
        var _this = this;
    ...
    //   });
    // }
    PodetailsPage.prototype.syncUpdatedPO = function () {
        var _this = this;
        debugger;
        this.syncService.getAlldelPOS().then(function (data) {
            if (data.length > 0) {
                var url = _this.databaseprovider.getURL();
                debugger;
                _this.nativeHttp.setDataSerializer("json");
                var nativeCall = _this.nativeHttp.post(url + '/delPOS.php', {
                    "POSIDS": data
                }, {
                    'Content-Type': 'application/json',
                    'x-api-key': '28b32377-cd77-44b3-8cbb-a9dc69bfddf4'
                ...
                Object(rxjs__WEBPACK_IMPORTED_MODULE_13__["from"])(nativeCall).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["finalize"])(function () { }))
                    ...
                    if (g.success === 1) {
                        // alert('success');
                        _this.syncService.updatedelsPOS().then(function (data) {
                        });
                        _this.syncService.syncAddedPOS().then(function (data) {
                            if (data.length > 0) {
                                ...
                                Object(rxjs__WEBPACK_IMPORTED_MODULE_13__["from"])(nativeCall_1).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["finalize"])(function () { }))
                                    ...
                                    if (g.success === 1) {
                                        // alert('success');
                                        _this.syncService.updateSyncedPOS(IDs_1).then(function (data) {
                                        });
                                        _this.syncService.syncAddedPOsItems().then(function (data) {
                                            if (data.length > 0) {
                                                ...
                                                Object(rxjs__WEBPACK_IMPORTED_MODULE_13__["from"])(nativeCall_2).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["finalize"])(function () { }))
                                                    ...
                                                    if (g.success === 1) {
                                                        //alert('success');
                                                        _this.syncService.updateSyncedPOSItems(IDs_2).then(function (data) {
                                                        });
                                                    }
                                                    else {
                                                        //alert('failed');
    ...
    PodetailsPage.prototype.syncdelPOS = function () {
        var _this = this;
        this.syncService.getAlldelPOS().then(function (data) {
            if (data.length > 0) {
                var url = _this.databaseprovider.getURL();
    ...
    // }
    PodetailsPage.prototype.updateItem = function (searchbar, item) {
        debugger;
        var x = item.CostPrice * item.Qty;
        this.subtotal = this.subtotal - x;
        var q = searchbar.srcElement.value;
    ...
    PodetailsPage.prototype.saveALert = function (head, sub, msg) {
        var _this = this;
        this.alrtCtrl.create({
            header: head,
            subHeader: sub,
    ...
    PodetailsPage.prototype.AddItems = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    PodetailsPage.prototype.call = function () {
        debugger;
        var number = this.PO.Phone.toString();
        this.callnumber.callNumber(number, true)
            .then(function (res) { return console.log('Launched dialer!', res); })
            .catch(function (err) { return console.log('Error launching dialer', err); });
    };
    PodetailsPage.prototype.Sms = function () {
        var number = this.PO.Phone.toString();
        this.socialSharing.shareViaSMS('', number).then(function () {
        }).catch(function () {
        });
    };
    PodetailsPage.prototype.copypaste = function () {
        console.log("1");
        this.syncService.getLedgerVendor(this.selectedVendorID);
    };
    PodetailsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-purchased-orders-podetails-podetails-module-es5.js.map