...
var ClientPage = /** @class */ (function () {
    function ClientPage(contacts, databaseprovider, storage) {
        var _this = this;
    ...
    ClientPage.prototype.getContact = function () {
        var _this = this;
        this.contacts.pickContact().then(function (contact) {
            _this.contactsfound = contact;
            console.log(_this.contactsfound);
            _this.contactor.displayName = contact.displayName;
            _this.contactor.phoneNumbers = contact.phoneNumbers[0].value;
            _this.contactor.email = contact.emails[0].value;
            _this.name = _this.contactor.displayName;
            _this.phone = _this.contactor.phoneNumbers;
            _this.email = _this.contactor.email;
            console.log(_this.email);
            console.log(_this.phone);
            console.log(_this.name);
        });
    };
    ClientPage.prototype.addClientInfo = function () {
        var _this = this;
    ...
    ClientPage.prototype.loadClientData = function () {
        var _this = this;
        this.databaseprovider.getAllClient().then(function (data) {
            _this.clients = data;
        });
    };
    ClientPage.prototype.Cickit = function () {
    ...
    ClientPage.prototype.getStartDate = function () {
