...
let TrashPurchasedOrdersPageModule = class TrashPurchasedOrdersPageModule {
};
...
let TrashPurchasedOrdersPage = class TrashPurchasedOrdersPage {
    constructor(router, http, nativeHttp, plt, loadingCtrl, databaseprovider, callnumber, syncService, network, storage, datePipe, alertCtrl, socialSharing, file, fileOpener) {
        this.router = router;
        this.http = http;
        ...
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(event => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationStart"])).subscribe((route) => {
    ...
    restore(item) {
        ...
        this.syncService.getVendorSync(item.VendorID).then((data) => {
            ...
            debugger;
            this.syncService.restorePO(item.ID, item.Total, item.VendorID, vendorSync).then(() => {
    ...
    getAllPosLocaldb() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let loading = yield this.loadingCtrl.create();
            yield loading.present();
            this.syncService.getAllDeletedPOS().then((data) => {
                debugger;
                this.POs = data;
                this.databaseprovider.setupdatePOS(0);
                this.initializePOs();
...
TrashPurchasedOrdersPage.ctorParameters = () => [
...
//# sourceMappingURL=trash-purchased-orders-trash-purchased-orders-module-es2015.js.map