...
var ItemamountPageModule = /** @class */ (function () {
    function ItemamountPageModule() {
    }
...
var ItemamountPage = /** @class */ (function () {
    function ItemamountPage(router, databaseprovider, platform) {
    ...
    ItemamountPage.prototype.ngOnInit = function () {
        // this.selectdItems = this.databaseprovider.getSeletedItems();
    };
    ItemamountPage.prototype.change = function (value) {
        if (value < 0) {
            console.log('no');
        }
        if (value > 0) {
    ...
    ItemamountPage.prototype.rateClicked = function (position) {
        var a = this.selectdItems[position].qty;
        // tslint:disable-next-line: radix
        if (a === '') {
            var index = this.qty.findIndex(function (x) { return x.pos === position; });
            var b = this.qty[index].qty;
    ...
    ItemamountPage.prototype.qtyClicked = function (position) {
        var a = this.selectdItems[position].rate;
        // tslint:disable-next-line: radix
        if (a === '') {
            var index = this.rate.findIndex(function (x) { return x.pos === position; });
            var b = this.rate[index].rate;
    ...
    ItemamountPage.prototype.save = function () {
        this.selectdItems;
        var num = 0;
        var des = 0;
        var a = true;
        // tslint:disable-next-line: prefer-for-of
        for (var i = 0; i < this.selectdItems.length; i++) {
    ...
    ItemamountPage.prototype.tax = function (value, position) {
        console.log(value.detail.checked, position);
        this.selectdItems[position].tax = value.detail.checked;
    };
    ItemamountPage.prototype.back = function () {
        debugger;
        this.databaseprovider.deleteAllSelectedItems();
        this.selectdItems = [];
        this.router.navigate([this.url]);
    };
    ItemamountPage.prototype.ionViewDidEnter = function () {
        document.addEventListener("backbutton", function (e) {
            console.log("disable back button");
        }, false);
    };
    ItemamountPage.prototype.isReadonly = function () { return true; };
    ItemamountPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-itemamount-itemamount-module-es5.js.map