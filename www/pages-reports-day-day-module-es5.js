...
var DayPageRoutingModule = /** @class */ (function () {
    function DayPageRoutingModule() {
    }
...
var DayPage = /** @class */ (function () {
    function DayPage(router, syncService, loadingCtrl, datePipe, datepicker, plt, socialSharing, file, fileOpener, storage, databaseservice) {
        var _this = this;
        this.router = router;
        ...
        var firstdayofmonth = new Date(new Date(this.day).getFullYear(), new Date(this.day).getMonth(), 1).setHours(0, 0, 0, 0);
        var first1 = this.datePipe.transform(firstdayofmonth, 'dd MMM yyyy h:mm a');
        var lastdayofmonth = new Date(new Date(this.day).getFullYear(), new Date(this.day).getMonth() + 1, 0).setHours(23, 59, 59, 999);
    ...
    DayPage.prototype.share = function () {
        // this.getData();
        this.createPdf();
    };
    DayPage.prototype.back = function () {
        this.router.navigate(['/menu/reports']);
    };
    DayPage.prototype.onActivate = function (event) {
        if (event.type === 'click') {
            console.log(event.row);
        }
    };
    DayPage.prototype.getData = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        b = this.datePipe.transform(start, 'dd MMM yyyy h:mm a');
                        // alert('start:' + this.start + '\ncurrent:' + this.end);
                        // alert('day:' + this.day)
                        this.syncService.getTodaysSales(this.start, this.end, this.currency).then(function (data) {
                            _this.total = data;
                            console.log(data);
                            for (var i = 0; i < _this.total.length; i++) {
                                var data1 = {
                                    day: _this.total[i].Date,
    ...
    DayPage.prototype.selectDate = function () {
        var _this = this;
        var options = {
            date: new Date(),
            mode: 'date',
        ...
        this.datepicker.show(options).then(function (date) {
            _this.day = _this.datePipe.transform(date, 'dd MMM yyyy h:mm a');
            _this.data = [];
            _this.getData();
            // console.log('selected:',this.myDate);
        });
    };
    DayPage.prototype.changeDate = function () {
    ...
    DayPage.prototype.createPdf = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    DayPage.prototype.ionViewWillLeave = function () {
        this.databaseservice.setSalesByDayValue(2);
    };
    DayPage.prototype.downloadPdf = function (loading) {
        var _this = this;
        debugger;
...
//# sourceMappingURL=pages-reports-day-day-module-es5.js.map