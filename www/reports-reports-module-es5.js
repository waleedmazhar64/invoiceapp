...
var ReportsPage = /** @class */ (function () {
    function ReportsPage(router, databaseservice) {
        this.router = router;
        this.databaseservice = databaseservice;
    }
    ReportsPage.prototype.ngOnInit = function () {
    };
    ReportsPage.prototype.day = function () {
        this.databaseservice.setSalesByDayValue(2);
        this.router.navigate(['day']);
    };
    ReportsPage.prototype.month = function () {
        this.databaseservice.setSalesByDayValue(2);
        this.router.navigate(['month']);
    };
    ReportsPage.prototype.client = function () {
        this.databaseservice.setSalesByDayValue(2);
        this.router.navigate(['customer']);
    };
    ReportsPage.prototype.item = function () {
        this.databaseservice.setSalesByDayValue(2);
        this.router.navigate(['item']);
    };
    ReportsPage.prototype.expenseCategory = function () {
        this.databaseservice.setSalesByDayValue(2);
        this.router.navigate(['expensecategory']);
    };
    ReportsPage.prototype.expenseJournal = function () {
        this.databaseservice.setSalesByDayValue(2);
        this.router.navigate(['expensejournal']);
    };
    ReportsPage.prototype.customerAging = function () {
        this.databaseservice.setSalesByDayValue(2);
        this.router.navigate(['customeraging']);
    };
    ReportsPage.prototype.year = function () {
        this.databaseservice.setSalesByDayValue(2);
        this.router.navigate(['year']);
    };
    ReportsPage.prototype.quarter = function () {
        this.databaseservice.setSalesByDayValue(2);
        this.router.navigate(['quarter']);
    };
    ReportsPage.prototype.customerStatement = function () {
        this.databaseservice.setSalesByDayValue(2);
