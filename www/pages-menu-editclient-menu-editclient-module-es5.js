...
var MenuEditclientPageModule = /** @class */ (function () {
    function MenuEditclientPageModule() {
    }
    ...
    return MenuEditclientPageModule;
}());
...
var MenuEditclientPage = /** @class */ (function () {
    function MenuEditclientPage(router, location, alertCtrl, contacts, plt, http, nativeHttp, loadingCtrl, databaseservice, syncService, network, storage, datePipe, formbuilder) {
        var _this = this;
        this.router = router;
    ...
    MenuEditclientPage.prototype.getformattedDate = function () {
    ...
    MenuEditclientPage.prototype.ngOnInit = function () {
    };
    MenuEditclientPage.prototype.close = function () {
        this.location.back();
    };
    MenuEditclientPage.prototype.save = function () {
    ...
    MenuEditclientPage.prototype.getDataNativeHttp = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        nativeCall = this.nativeHttp.post(url + '/updateClient.php', this.client, {
    ...
    MenuEditclientPage.prototype.AddLog = function () {
        var _this = this;
        if (this.usdId === 1) {
    ...
    MenuEditclientPage.prototype.GetLogs = function () {
        this.syncService.getAllLogs().then(function (data) {
            console.log(data);
        });
    };
    MenuEditclientPage.prototype.updateClient = function () {
        var _this = this;
    ...
    MenuEditclientPage.prototype.syncUpdateClients = function () {
        var _this = this;
    ...
    MenuEditclientPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-menu-editclient-menu-editclient-module-es5.js.map