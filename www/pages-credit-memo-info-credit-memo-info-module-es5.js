...
var CreditMemoInfoPageModule = /** @class */ (function () {
    function CreditMemoInfoPageModule() {
    }
    ...
    return CreditMemoInfoPageModule;
}());
...
var CreditMemoInfoPage = /** @class */ (function () {
    function CreditMemoInfoPage(storage, router, datePipe, datePicker, alertCtrl) {
    ...
    CreditMemoInfoPage.prototype.ngOnInit = function () {
    };
    CreditMemoInfoPage.prototype.back = function () {
    ...
    CreditMemoInfoPage.prototype.selectDate = function () {
        var _this = this;
        var options = {
            date: new Date(),
            mode: 'date',
        ...
        this.datePicker.show(options).then(function (date) {
            _this.creditmemo.created = _this.datePipe.transform(date, 'dd-MM-yyyy');
            // console.log('selected:',this.myDate);
        });
    };
    CreditMemoInfoPage.prototype.openAlert = function () {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function (data) {
                        ...
                        _this.creditmemo.terms = data;
                    }
                }
            ]
        }).then(function (alert) { return alert.present(); });
    };
    CreditMemoInfoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-credit-memo-info-credit-memo-info-module-es5.js.map