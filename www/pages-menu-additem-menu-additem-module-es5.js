...
var MenuAdditemPageModule = /** @class */ (function () {
    function MenuAdditemPageModule() {
    }
...
var MenuAdditemPage = /** @class */ (function () {
    function MenuAdditemPage(location, alertCtrl, contacts, plt, http, nativeHttp, loadingCtrl, databaseservice, router, syncService, network, storage, datePipe, formbuilder) {
        var _this = this;
    ...
    MenuAdditemPage.prototype.ngOnInit = function () {
    };
    MenuAdditemPage.prototype.getformattedDate = function () {
    ...
    MenuAdditemPage.prototype.close = function () {
        this.location.back();
    };
    MenuAdditemPage.prototype.save = function () {
        debugger;
    ...
    MenuAdditemPage.prototype.getDataNativeHttp = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        nativeCall = this.nativeHttp.post(url + '/createItem.php', this.item, {
    ...
    MenuAdditemPage.prototype.AddLog = function () {
        var _this = this;
        if (this.usdId === 1) {
    ...
    MenuAdditemPage.prototype.GetLogs = function () {
        this.syncService.getAllLogs().then(function (data) {
            console.log(data);
        });
    };
    MenuAdditemPage.prototype.getCid = function () {
        var _this = this;
        this.syncService.getItemssonspot().then(function (data) {
            _this.getId = data;
            console.log(_this.getId);
            _this.tblId = _this.getId[0].itemid;
            _this.name = _this.getId[0].Description;
            debugger;
            console.log(_this.tblId);
            _this.AddLog();
        });
    };
    MenuAdditemPage.prototype.addItem = function () {
        var _this = this;
        this.syncService.additem(this.item.Description, this.item.Rate, this.item.Cost)
            ...
            if (_this.network.type === 'none') {
                ...
                debugger;
                _this.syncAddedItems();
            }
        });
    };
    MenuAdditemPage.prototype.syncAddedItems = function () {
        var _this = this;
    ...
    MenuAdditemPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-menu-additem-menu-additem-module-es5.js.map