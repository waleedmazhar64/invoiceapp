...
if (isset($jsondata['VendorID'])) 
{
   ...
   $VendorID = $jsondata['VendorID'];
    ...
    $result = mysqli_query($con,"UPDATE tblvendors SET bActive='1' where ID='$VendorID'");
    ...
    if ($result) {
		$response["success"] = 1;
        $response["message"] = "Vendor Successfully Activated";
        ...
        $response["success"] = 0;
        $response["message"] = "Vendor Failed to Activa";
