...
if (isset($jsondata['VendorID']) && isset($jsondata['Name'])&& isset($jsondata['Address'])&& isset($jsondata['Phone'])&& isset($jsondata['Email'])) 
{
   ...
   $Email = $jsondata['Email'];
    ...
    $result = mysqli_query($con,"UPDATE tblvendors SET Name='$Name',Address='$Address',Phone='$Phone',Email='$Email' where ID='$VendorID'");
    ...
    if ($result) {
        ...
        $response["success"] = 0;
        $response["message"] = "Vendor Failed to update";
