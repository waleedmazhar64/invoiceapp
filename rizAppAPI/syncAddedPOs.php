...
if (isset($jsondata['POS'])) 
{
    ...
    // mysql inserting a new row
		 ...
		 foreach($someObject as $value) {
			 ...
			 $sql1 = "INSERT INTO tblpurchasedorder(ID,VendorID,Date,ReceivedBy,Total,Remarks,Discount,Active) VALUES ('$value->ID','$value->VendorID','$value->Date','$value->ReceivedBy','$value->Total','$value->Remarks','$value->Discount','$value->Active')";
