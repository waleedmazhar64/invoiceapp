   ...
   $Clients = $jsondata['Clients']; //$conn->insert_id
    ...
    // mysql inserting a new row
		 ...
		 foreach($someObject as $value) {
			 ...
			 $sql1 = "UPDATE clients SET Fname='$value->Fname',Lname='$value->Lname',Shop='$value->Shop',BillingAddress='$value->BillingAddress',City='$value->City',Cell='$value->Cell',Active='$value->Active',Balance='$value->Balance' where Cid='$value->Cid'";
