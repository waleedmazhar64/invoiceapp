   ...
   $Items = $jsondata['Items']; //$conn->insert_id
    ...
    // mysql inserting a new row
		 ...
		 foreach($someObject as $value) {
			 ...
			 $sql1 = "INSERT INTO items(itemid,AccountId,Description,Rate,Cost,Instock,Active)  VALUES ('$value->itemid','$value->AccountId','$value->Description','$value->Rate','$value->Cost','$value->Instock','$value->Active')";
