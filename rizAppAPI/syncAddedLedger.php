...
if (isset($jsondata['Payments'])) 
{
    ...
    // mysql inserting a new row
		 ...
		 foreach($someObject as $value) {
			 ...
			 $sql1 = "INSERT INTO tblledger(ID,InvoiceID,Date,Amount,CustomerID,IsCredit,Duedate,ByUserId,Remarks) VALUES ('$value->ID','$value->InvoiceID','$value->Date','$value->Amount','$value->CustomerID','$value->IsCredit','$value->Duedate','$value->ByUserId','$value->Remarks')";
