   ...
   $Vendors = $jsondata['Vendors']; //$conn->insert_id
    ...
    // mysql inserting a new row
		 ...
		 foreach($someObject as $value) {
			 ...
			 $sql1 = "UPDATE tblvendors SET Name='$value->Name',Address='$value->Address',Phone='$value->Phone',Email='$value->Email',Balance='$value->Balance',bActive='$value->bActive' where ID='$value->ID'";
