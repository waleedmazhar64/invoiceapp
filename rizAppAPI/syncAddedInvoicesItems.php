...
if (isset($jsondata['InvoiceItems'])) 
{
    $InvoiceItems = $jsondata['InvoiceItems']; //$conn->insert_id
    ...
    // mysql inserting a new row
         ...
         $someObject = json_decode($InvoiceItems);
		 foreach($someObject as $value) {

			 
			 $sql1 = "INSERT INTO invoiceitems(Iiid,Iid,Itemid,Qty,CostPrice) VALUES ('$value->Iiid','$value->Iid','$value->Itemid','$value->Qty','$value->CostPrice')";
