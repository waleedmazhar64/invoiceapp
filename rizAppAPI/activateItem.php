...
if (isset($jsondata['itemid'])) 
{
   $itemid = $jsondata['itemid'];	
    ...
    $result = mysqli_query($con,"UPDATE items SET Active='1' where itemid='$itemid'");
    ...
    if ($result) {
		$response["success"] = 1;
        $response["message"] = "Item Successfully Activated";
        ...
        $response["success"] = 0;
        $response["message"] = "Item Failed to activate";
