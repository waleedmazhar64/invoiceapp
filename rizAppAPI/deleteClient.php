...
if (isset($jsondata['Cid'])) 
{
   $Cid = $jsondata['Cid'];	
    ...
    $result = mysqli_query($con,"UPDATE clients SET Active='0' where Cid='$Cid'");
    ...
    if ($result) {
		$response["success"] = 1;
        $response["message"] = "Client Successfully Deactivated";
        ...
        $response["success"] = 0;
        $response["message"] = "Client Failed to deactive";
